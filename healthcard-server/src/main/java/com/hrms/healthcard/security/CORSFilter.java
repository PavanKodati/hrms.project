...
/**
 *  Copyright (C) 2017 ThreadResearch, Inc. <info@thread.com>
 *
 *  This file is part of ThreadResearch Auth Server.
 *
 *  ThreadResearch Auth Server can not be copied and/or distributed without
 *  the express permission of ThreadResearch, Inc..
 */
